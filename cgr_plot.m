...
%% Method 3
set(gca, 'LooseInset', [0.1,0.1,0.1,0.1]);          % http://undocumentedmatlab.com/blog/axes-looseinset-property/
% set(gcf,'Visible', 'off')
set(gcf,'Color','w')
...
text(-0.625,-0.325,'\bf{A}','Interpreter','Latex','FontSize',25);
text(-0.625,10.325,'\bf{C}','Interpreter','Latex','FontSize',25);
text(10.325,10.325,'\bf{G}','Interpreter','Latex','FontSize',25);
text(10.325,-0.325,'\bf{T}','Interpreter','Latex','FontSize',25);
axis('off')
